...
<html>
<head>
<title>ALFANDY FLOWER SHOP - Checkout</title>
<!-- for-mobile-apps -->
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">alfandyflowershop@gmail</a></li>
